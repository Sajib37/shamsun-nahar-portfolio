      ...
      <div className="max-w-7xl mx-auto ">
        ...
        <section className="lg:w-[85%] mx-auto mt-6 md:mt-8 lg:mt-10 flex-col lg:flex-row-reverse flex gap-8 md:gap-12 lg:gap-20 items-start">
          <div className="wrapper  rounded-full w-4/5 mx-auto flex-1 lg:w-96">
            <div className="box rounded-full  p-4 bg-[#8228ec] w-full  flex items-center justify-center">
        ...
        <section className="relative">
          <div className="relative   ">
            ...
            {/* Skills categories */}
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 pt-10 md:pt-12 lg:pt-16 items-center ">
